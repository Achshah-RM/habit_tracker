...
class HabitTrackerGUI:
    ...
    def view_all_habits(self):
        ...
        # Heading - All Habits
        all_habits_heading = tk.Label(view_all_window, text="All Habits", font=heading_font, fg="white", bg="black")
        all_habits_heading.pack(pady=20)

        # Create a frame to hold the content
        content_frame = tk.Frame(view_all_window, bg="black")
        content_frame.pack(fill=tk.BOTH, expand=True)

        # Create a canvas with scrollbar
        canvas = tk.Canvas(content_frame, bg="black")
        ...
        for habit in habits:
            ...
            view_analytics_button.pack(pady=5)
